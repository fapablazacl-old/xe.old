...
void (CODEGEN_FUNCPTR *_ptrc_glPoinSize)(GLfloat ) = NULL;
...
static int Load_Version_3_3()
{
	...
	_ptrc_glPoinSize = (void (CODEGEN_FUNCPTR *)(GLfloat ))IntGetProcAddress("glPoinSize");
	if(!_ptrc_glPoinSize) numFailed++;
